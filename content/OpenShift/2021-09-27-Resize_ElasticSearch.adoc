--- 
title: "Online Resize Elasticsearch Storage"
description: "Resize ElasticSearch Storage online and without service disruption"
date: "2021-09-27"
doctype: book


author: Christian Tawfik
type: post
draft: true
categories:
   - OpenShift
tags: ["Storage", "OpenShift", "OCP", "Elasticsearch", "PVC", "PV"]

aliases: [ 
	 "/posts-output/2021-09-27-resize-elasticsearch",
] 
---
